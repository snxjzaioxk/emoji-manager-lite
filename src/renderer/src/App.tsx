...
const mockElectronAPI: MockElectronAPI = {
  categories: {
    ...
    add: (_category: Omit<Category, 'createdAt' | 'updatedAt'>) => Promise.resolve(),
    update: (_id: string, _updates: Partial<Category>) => Promise.resolve(),
...
// 设置模拟 API（仅在开发环境且未由 preload 注入时）
